    ...
    <>
      ...
      >
        <AboutContainer>
          ...
          <AboutText>
            Хомяк потерял любимую сырную корочку, а его хозяин ушёл на весь день
            и забыл насыпать корм. Одиночество давит на него, и он смотрит на
            мир огромными заплаканными глазами под тоскливую музыку.
          </AboutText>
          <AboutText>
            <b>Главная цель:</b> помочь хомяку пройти 5 стадий от отчаяния до
            полного счастья — через клики, уют, заботу и маленькие радости.
            Каждый шаг приносит тепло, надежду и, наконец, улыбку.
          </AboutText>
          <AboutText>
            В игре доступно <b>{achievementsCount} достижений</b> и{" "}
            <b>{itemsCount} предметов</b> уюта. В процессе ты развиваешь хомяка
            от грусти к живому, яркому счастью.
          </AboutText>
